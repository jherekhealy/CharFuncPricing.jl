...
df = exp(-r*τ)
forward = S0/df
params = HestonParams(0.0654, 0.6067, 0.0707, -0.7571, 0.2928)
...
cf = DefaultCharFunc(params)
pricers = [ALCharFuncPricer(cf, quadratureGL), makeCosCharFuncPricer(cf, τ, 200, 8), makeCosCharFuncPricer(cf, τ, tol=1e-4),
